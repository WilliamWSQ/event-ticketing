...
import { gradShift, glowBreath, rise, spinSlow } from '@shared/theme';
...
`;
const HeroArrow = styled(ArrowRight)`
  color: ${(p) => p.theme.color.cyan};
`;
  ...
  return (
    <Main>
      <Hero>
        ...
        <HeroActions>
          <HeroPrimary onClick={() => navigate(`/concert/${FEATURED_ID}`)}>
            {t.getTickets}
            <HeroArrow size={18} strokeWidth={2.2} />
          </HeroPrimary>
          <HeroGhost>
            <PlayIcon size={16} />
            {t.trailer}
